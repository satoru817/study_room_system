...
import { STUDENT_REGISTER_REQUEST_URL } from '../constant/urls';
...
function StudentRegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await doPost(STUDENT_REGISTER_REQUEST_URL, {
                token,
                loginName,
                password,
            });
            ...
            <div className="card-body">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        />
                        {errors.loginName && (
                            <div className="invalid-feedback">{errors.loginName}</div>
                        )}
                    </div>
